...
namespace CabinIcarus.BoltExtensions
{
    public partial class UpdateUnitTools:EditorWindow
    {
        ...
        private readonly Dictionary<HelpType,Dictionary<string,string>> _i18NManager = new Dictionary<HelpType,Dictionary<string,string>>();
        ...
        void _initLanage()
        {
            _i18NManager.Add(HelpType.en,new Dictionary<string, string>()
            {
        ...
        private string _getMessage(string key)
        {
            switch (_helpType)
            {
                ...
                default:
                    return _i18NManager[HelpType.en][key];
            }
        }

        string _getI18NValue(string  key)
        {
            return _i18NManager[_helpType][key];
        }
